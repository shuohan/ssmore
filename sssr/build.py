...
def build_trainer(sampler, slice_profile, net, optim, loss_func, args):
    ...
    logger = EpochLogger(args.log_filename)
    ...
    image_saver = ImageSaver(args.image_dirname, attrs=attrs,
